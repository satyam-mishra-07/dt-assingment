...
desc = document.querySelector("main .hero-section .one .desc");
img = document.querySelector(".hero-section .two");
descp = document.querySelector("section .container .descp");
out = document.querySelector("section .container .outcome ul");
pre = document.querySelector("section .container .pre ul");
content = document.querySelector("section .container .content");



title.innerHTML = jsonData.title;
desc.innerHTML = jsonData.short_description;
img.innerHTML = `<img src="${jsonData.project_image}" alt="project image">`;
descp.innerHTML = jsonData.description;
content.innerHTML = jsonData.commitment;

jsonData.learning_outcomes.forEach((element) => {
    out.innerHTML += `<li>${element}</li>`;
});

jsonData.pre_requisites.forEach((element) => {
    pre.innerHTML += `<li>${element}</li>`;
});